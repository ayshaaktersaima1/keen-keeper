    ...
    return (
        <div>
            <div className='text-center pt-10 md:pt-20 pb-5 md:pb-10'>
                <h1 className='primary-color text-3xl md:text-5xl font-bold'>Friends to keep close in your life</h1>
            ...
            <div className='grid grid-cols-2 lg:grid-cols-4 justify-center  gap-6 w-full items-stretch'>
                <div className='h-full flex-1 space-y-2 text-center py-8 border border-[#000000]/8 shadow-sm rounded-lg bg-white'>
